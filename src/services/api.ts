...
const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || 'https://formregistrofiscales2025.onrender.com';

// Modo de desarrollo - forzar a false para probar con API real
